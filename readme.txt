...
Tags:              dashboard, admin, widget, dashboard widget, widgets, admin widget, admin dashboard, priority, side, user dashboard
...
[Fixed] If you placed more of the same widget type, then the titles would be the same (http://wordpress.org/support/topic/widget-titles-2). Thanks to Nick (nikmav) for the fix of this bug.
